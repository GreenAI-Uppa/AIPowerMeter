...
mapping = {'number_of_jobs':'#jobs', 
    ...
    'job_id':'job_id',
    'job_name':'job_name',
    'gpu_consumption':'GPU Consumption (WH)', 
    'gpu_emission_rte':'GPU Emission RTE (gCO2eq)',
    'gpu_emission_ademe':'GPU Emission ADEME (gCO2eq)',
    'cpu_consumption':'CPU Consumption (WH)',
    'cpu_emission_rte':'CPU Emission RTE (gCO2eq)',
    'cpu_emission_ademe':'CPU Emission ADEME (gCO2eq)',
